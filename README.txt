...
1 - FPS Audio Exercise (school project)
...
2 - Flooded Village (school project)
Purpose : learning about Unity tilemaps and mouse controls. I did challenge myself adding some UI animations, polishing and tutorials.
Material : "Game" concept and art were given by the school.
What I did : Everything except concept and art. 
- Interaction with tilemap in code
- Interactive tutorials
- Polish : cursors, sound, UI animations

------------------------------------------------------------------------------

3 - CityBuilderWithAsync
...
4 - Mastermind 
Purpose : Quick challenge with a pair developer in order to manipulate strings.
