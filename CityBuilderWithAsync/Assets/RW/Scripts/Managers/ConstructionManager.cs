    ...
    public class ConstructionManager : MonoBehaviour
    {
        ...
        public async void BuildStructure(GameObject placementStructure, Vector3 buildPosition)
        {
            ...
            if (placementStructure.TryGetComponent(out RoadBuildPropertiesContainer roadBuildPropertiesContainer))
            {
                ...
                // EXAMPLE WITH NON ASYNC METHOD : Decomment line 36, comment lines 37, 38, erase "async" keyword on this method. --> Now impossible to build a 2nd road before the 1st one is finished.
        ...
        // SYNC TASK FOR EXAMPLE - Diff between async and sync
        ...
        private void Update()
        {
            // Next step : cancelling a construction pressing the ESC key
        }

        private void OnDisable()
        {
            // Show what happens if we do not cancel ongoing tasks OnDisable --> start a construction, quit play mode, see that the construction continues !!
        }
